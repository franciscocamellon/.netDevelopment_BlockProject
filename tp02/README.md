...
* [Introdução](https://github.com/franciscocamellon/.netDevelopment_BlockProject/wiki/Introdu%C3%A7%C3%A3o)

* [Requisitos de usuário](https://github.com/franciscocamellon/.netDevelopment_BlockProject/tree/master/tp01#13--requisitos-de-usu%C3%A1rio)

* [Requisitos de sistema](https://github.com/franciscocamellon/.netDevelopment_BlockProject/tree/master/tp02)  
...
### RS1 - Criar perfil na rede social
...
| Dados                     | Username: Texto, máximo de 100 caracteres.<br>Email: email válido.<br>Projeto: texto, máximo de 100 caracteres.<br>Aplicativo: link para a loja de aplicativos.<br>Tecnologia utilizada: lista das tecnologias envolvidas.<br>Galeria: GIF, PNG, MP4 ou JPEG, máximo 15Mb|
...
| Requisitos   relacionados | RS1, RS2 e RS3 |  
